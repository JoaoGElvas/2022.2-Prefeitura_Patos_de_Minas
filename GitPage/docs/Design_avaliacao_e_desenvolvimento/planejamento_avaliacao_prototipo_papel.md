...
*Qualquer pessoa que se encaixe em algum desses perfis estão aptos a serem recrutados para a atividade de validação.*
...
3. Durante a avaliação realize as atividades detalhadas no tópico ***Avaliação***;
...
| ------ | ---------- | ---------------------------- | ------------------ | ------------------- |
| 1.0    | 21/12/2022 | Criação do documento         | João Gabriel Elvas |                     |
