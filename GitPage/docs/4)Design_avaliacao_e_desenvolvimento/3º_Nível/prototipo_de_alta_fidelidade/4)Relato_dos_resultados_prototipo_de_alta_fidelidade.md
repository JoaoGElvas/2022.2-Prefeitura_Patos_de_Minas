...
- O usuário seleciona o campo diário oficial presente na barra lateral.
- Procura pela 2ª edição e a seleciona.
- Seleciona o botão "baixar edição".

### 3- Receitas:

- Usuário seleciona o campo "Portal da Transparência" presente nos icones superiores da página.
...
- A usuária seleciona o campo diário oficial presente na barra lateral.
- Procura pela 2ª edição e a seleciona.
- Seleciona o botão "baixar edição".

### 3- Receitas:

- Usuária seleciona o campo "Portal da Transparência" presente nos icones superiores da página.
- Procura por receitas dando scroll na pagina e após encontrar seleciona.
- Preenche os campos da receita, mas tem dificuldade com o protótipo só aceitar 01 ao invés de 1.
- Realiza a pesquisa.
- Retorna ao formulário de receita apertando o botão "voltar".
